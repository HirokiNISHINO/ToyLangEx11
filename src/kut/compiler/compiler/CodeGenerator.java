...
public class CodeGenerator 
{
	...
	protected SymbolTable	globalSymbol;
	...
	public CodeGenerator(AstNode program, String filename, Platform platform) 
	{
		...
		this.globalSymbol = new SymbolTable();
	}
	...
	{
		this.globalSymbol.addGlobalVariable(gvar);
	}
	...
	{
		SymbolType t = this.globalSymbol.getSymbolType(identifier);	
		return t;
	}
	...
	public void allocateGlobalVariables() throws IOException
	{
		...
		List<String> gvs=  globalSymbol.getGlobalVariables();
	...
	public void printGlobalVariables() {
		this.globalSymbol.printGlobalVariables();
	}
